...
public class BitmapParallelBuilder extends BitmapBuilder {
     ...
     * @param points
     */
    public BitmapParallelBuilder(ImageView testImgView, Points points, int bitmapWidth, int bitmapHeigth, @NonNull int[] leftColor, @NonNull int[] rightColor, int colorshape) {
        super(testImgView, points, bitmapWidth, bitmapHeigth, leftColor, rightColor, colorshape);
    }

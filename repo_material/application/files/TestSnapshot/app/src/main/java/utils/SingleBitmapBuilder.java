...
public class SingleBitmapBuilder extends BitmapBuilder {
     ...
     * @param colorshape
     */
    public SingleBitmapBuilder(ImageView testImgView, Points points, int bitmapWidth, int bitmapHeigth, @NonNull int[] leftColor, @NonNull int[] rightColor, int colorshape) {

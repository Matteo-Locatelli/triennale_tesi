...
import utils.BitmapBuilder;
import utils.BitmapParallelBuilder;
import utils.SingleBitmapBuilder;
import utils.AnaglyphSATest;
import utils.SingleTest;
...
public class ImagesDisplayActivity extends AppCompatActivity {
    ...
    /** parte relativa alla misura del display */
    /** parametri display */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // seleziono un'immagine tra quelle presenti in RIDsimages e la posiziono su tutte le imageview
        Random r = new Random();
        int n = r.nextInt(4);
        int RIDImageTest = RIDsImages[n];
        ...
        // Register this
        // satTest.addObserver((Observer) this);    -> problema
    ...
    public void setBackgroundForTest(){
        ...
        for(int i=0; i<DefaultValues.NUMBER_IMAGES; i++) {
            int width= tests[i].imageView.getWidth();
            int height = tests[i].imageView.getHeight();

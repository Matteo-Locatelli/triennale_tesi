...
import static com.example.stereoacuitymultitestapp.utils.HashFunction.toSha256;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // if the user wants to proceed without registration
        Button mNotRegUserButton = findViewById(R.id.noreg_test);
        mNotRegUserButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LoginActivity.this,NoRegPatientActivity.class);
    ...
    class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
         ...
         * @param password
         */
        public UserLoginTask(String mail, @NonNull String password) {
            mMail = mail;

...
public class CalcolatoreDisparities {
    ...
    public CalcolatoreDisparities(){
        ...
        this.maxDisparity = absoluteMaxDisparity;
        this.minDisparity = absoluteMinDisparity;
    }

    public CalcolatoreDisparities(int absoluteMaxDisparity){
        CalcolatoreDisparities.absoluteMaxDisparity = absoluteMaxDisparity;
        this.maxDisparity = CalcolatoreDisparities.absoluteMaxDisparity;
        this.minDisparity = absoluteMinDisparity;
    }

    /** metodo che costruisce il vettore di disparità
     * dato il corrente min e massimo
     * esempio : min 1 , max 10 -> [0,10,5,1,0, 0]
     */

...
import com.example.stereoacuitymultitestapp.utils.ListViewAdapter;
import com.example.stereoacuitymultitestapp.utils.Patient;
...
public class PatientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Intent
                Intent intent = new Intent(PatientActivity.this, CreatePatient.class);
    ...
    private void doActivity() {
        ...
        adapter = new ListViewAdapter(PatientActivity.this, patientArrayList);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // Toast
                Toast.makeText(PatientActivity.this, patientArraySort.get(position).toString(), Toast.LENGTH_LONG).show();
        ...
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(PatientActivity.this);
        ...
        search.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                adapter = new ListViewAdapter(PatientActivity.this, patientArraySort);
                list.setAdapter(adapter);
            }
        });
    }

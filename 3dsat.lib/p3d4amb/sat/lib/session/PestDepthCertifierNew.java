...
public class PestDepthCertifierNew extends DepthCertBase {
	...
	public PestDepthCertifierNew(int initDepth) {
	...
	public void computeNextDepth(DepthCertBase.Solution solution) {
		...
		// PART ONE
		// Quickly and approximately identify the range in which the level can be
		// contained
		if (firstPhase && (solution != DepthCertBase.Solution.NULL)) {
		...
		} else if (!firstPhase && (solution != DepthCertBase.Solution.NULL)) {

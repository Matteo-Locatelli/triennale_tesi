...
/** information about the screen where the images will be displayed.
 * Necessary to compute some other info, like points and so on
 * */
public class MonitorData {
	 ...
	 * @param monitorHeightPixel TODO
	 * @param monitorDistance the monitor distance in centimeters
	 */
	public MonitorData(double monitorSize10thInc, int monitorWidthPixels, int monitorWidthMM, int monitorHeightPixels, int monitorDistance) {
